class MediaOwnersController < ApplicationController
  ...
  def create
    @media_owner = media_owner.new(media_owner_params)

    respond_to do |format|
      if @media_owner.save
        format.html { redirect_to @media_owner, notice: "media_owner was successfully created." }
  ...
  def update
    respond_to do |format|
      if @media_owner.update(media_owner_params)
        format.html { redirect_to @media_owner, notice: "media_owner was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to media_owners_path, status: :see_other, notice: "media_owner was successfully destroyed." }
