...
ActiveRecord::Schema[8.1].define(version: 2026_07_10_233442) do
  ...
  create_table "media_items", force: :cascade do |t|
    ...
    t.index ["location_id", "slot_position"], name: "index_media_items_on_location_id_and_slot_position"
  ...
  create_table "pick_random_configs", force: :cascade do |t|
    ...
    t.string "location_scope", default: "none", null: false
  ...
  create_table "play_sessions", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["media_item_id"], name: "index_play_sessions_on_media_item_id"
  ...
  create_table "theme_sets", force: :cascade do |t|
    ...
    t.string "name"
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_theme_sets_on_name", unique: true
  end
  ...
  create_table "wishlist_items", force: :cascade do |t|
    ...
    t.integer "release_id", null: false
    t.datetime "updated_at", null: false
    t.index ["media_type_id"], name: "index_wishlist_items_on_media_type_id"
  ...
  add_foreign_key "wishlist_items", "media_types"
